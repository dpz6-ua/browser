...
#   DICHO DIRECTORIO NO CONTENDRA NINGUN ARCHIVO $EJE (p.ej. ya que en este fichero EJE=practica2, en ese directorio no podra haber ningun fichero que se llame "practica2")
#   DICHO DIRECTORIO CONTENDRA UN FICHERO makefile QUE GENERE EL EJECUTABLE $EJE CUYO PROGRAMA PRINCIPAL SERA $MAIN (p.ej. ya que en este fichero EJE=practica2, el makefile ha de crear un ejecutable de nombre "practica2", como el makefile mostrado en la siguiente seccion ) 
